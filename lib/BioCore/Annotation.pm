...
A Perl package for the annotation and filtering tools used in the Bioinformatics
Core group at the Princess Margaret Research Institute.

    use BioCore::Annotation;

    my  = BioCore::Annotation->new();
